            ...
            <>
                <Grid container justify="center">
                    ...
                    <Grid item md={6} sm={12} className={classes.grid}>
                        ...
                        {(result[0].expenseGroup != "Ordinarias") ? (
                            <Button fullWidth onClick={() => { window.open("https://www.figma.com/proto/vikIUDW9zdt0o0ffR3civo/Estudos-Self-Condo-Reembolso-e-Meu-Aluguel?node-id=2344%3A3316&viewport=3137%2C497%2C0.12901844084262848&scaling=scale-down") }} className={classes.button}>Pedir reembolso dessa despesa</Button>
                        ) : (
                                <>
                                    <Button fullWidth className={classes.button} onClick={() => history.push("/")}>Voltar às despesas para reembolso</Button>
                                    <Button fullWidth variant="secondary" onClick={() => { window.open("https://www.figma.com/proto/vikIUDW9zdt0o0ffR3civo/Estudos-Self-Condo-Reembolso-e-Meu-Aluguel?node-id=2344%3A3316&viewport=3137%2C497%2C0.12901844084262848&scaling=scale-down") }} className={classes.button}>Pedir reembolso dessa despesa</Button>
                                </>
                            )
                        }
                    </Grid>
