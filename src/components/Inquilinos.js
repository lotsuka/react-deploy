            ...
            <Grid container justify="center">
                <Grid item xs={12}>
                    <AppBar position="static" className={classes.appBarStyle}>
                        <ToolBar>
                            <IconButton button edge="start" className="Back" color="inherit" aria-label="menu" onClick={() => history.push("/nao-achei")}>
                                <ArrowBack />
                            </IconButton>


                            <Typography variant="h5" color="inherit">
                                Despesas de inquilinos
                            </Typography>
                        </ToolBar>
                    </AppBar>
                </Grid>
                <Grid item md={6} sm={12} className={classes.grid}>
                    ...
                    <Typography variant="body1" color="inherit" className={classes.body1}>
                        São relacionadas a gastos rotineiros para a manutenção do condomínio. Elas não são reembolsáveis.
                    </Typography>

                    <Box mt="2rem" />

                    <List className={classes.root}>
                        {expenseInfo.map(expenseNumber => expenseNumber.expenseGroup == "Ordinarias" ? showExpense(expenseNumber) : undefined)}
                    </List>
